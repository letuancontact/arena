...
// Tự động nạp tên cũ từ trình duyệt
...
const Network = {
  ...
  onMessage(msg) {
    ...
    if (data.type === "state") {
      ...
      const prevDead = GameState.isDead ?? true; // Mặc định vào web là đang ở sảnh (chết)
      ...
      if (me) {
        ...
        // QUẢN LÝ GIAO DIỆN KHI SỐNG LẠI
